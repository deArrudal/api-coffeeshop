...
public class ItemController {
    ...
    public Item readItem(@PathVariable Long customerOrderId, @PathVariable Long coffeeId) {
    ...
    public Item deleteItem(@PathVariable Long customerOrderId, @PathVariable Long coffeeId) {
